...
export const submittalsOpenApiDoc: ModuleOpenApiDoc = {
  ...
  paths: {
    ...
    "/submittal/pending/departmentManager": {
      get: {
        tags: ["Submittals"],
        summary: "GET /submittal/pending/departmentManager",
        operationId: "get_submittals_submittal_pending_departmentManager",
        security: [{ bearerAuth: [] }],
        responses: {
          "200": { description: "Success" },
          "400": { description: "Bad Request" },
    ...
    "/submittal/pending/operationExecutive": {
      get: {
        tags: ["Submittals"],
        summary: "GET /submittal/pending/operationExecutive",
        operationId: "get_submittals_submittal_pending_operationExecutive",
        security: [{ bearerAuth: [] }],
        responses: {
          "200": { description: "Success" },
          "400": { description: "Bad Request" },
    ...
    "/submittal/pending/CDAdmin": {
      get: {
        tags: ["Submittals"],
        summary: "GET /submittal/pending/CDAdmin",
        operationId: "get_submittals_submittal_pending_CDAdmin",
        security: [{ bearerAuth: [] }],
        responses: {
          "200": { description: "Success" },
          "400": { description: "Bad Request" },
    ...
    "/submittal/pending/clientSide": {
      get: {
        tags: ["Submittals"],
        summary: "GET /submittal/pending/clientSide",
        operationId: "get_submittals_submittal_pending_clientSide",
        security: [{ bearerAuth: [] }],
        responses: {
          "200": { description: "Success" },
          "400": { description: "Bad Request" },
    ...
    "/submittal": {
      post: {
        ...
        description: "Creates a new submittal. Note: To link milestones, pass 'mileStoneIds' as an array of milestone UUID strings. Do not use 'mileStoneLinks'. The 'notes' field can be passed to attach remarks/notes to the submittal.",
    ...
    "/submittal/sents/{projectId}": {
      get: {
        ...
        operationId: "get_submittals_submittal_sent_projectId",
        security: [{ bearerAuth: [] }],
        parameters: [
          { in: "path", name: "projectId", required: true, schema: { type: "string" } },
        ],
