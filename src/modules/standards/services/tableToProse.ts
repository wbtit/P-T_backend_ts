/**
 * Phase 5 §1.4: promoted verbatim from scratch/table-to-prose.ts (no logic
 * changes) -- Phase 4 already validated this on a 35-table stratified sample
 * (0 empty renders, 0 misattributions), so this port is packaging, not a
 * rewrite.
 *
