...
export const rfihtmlContent = (newrfi: any, fabricatorName?: string) => {
  ...
  const senderObj = newrfi.approvedBy || newrfi.sender;
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="email-container" style="max-width: 600px; background-color: #ffffff; border: 1px solid #e0e0e0;">
          ...
          <tr>
            <td class="content-body" style="padding: 40px 30px; color: #333333; line-height: 1.6;">
              ...
              <p style="margin: 0 0 20px 0;">You have received new <strong>Request for Information (RFI)</strong> for the above mentioned Project. Please find the details below:</p>
