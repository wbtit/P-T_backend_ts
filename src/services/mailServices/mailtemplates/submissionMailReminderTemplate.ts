  ...
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="content-body">
        ...
        <div class="subject-line">Subject: Project Submission Reminder - ${projectName}</div>
        
        <p>Dear ${recipientUsername || "Project Manager"},</p>
        
        <p>This is a friendly reminder about the upcoming <b>submission deadline</b> for your project on Project Station.</p>

        <p><strong>Project Name:</strong> ${projectName}</p>
        <p><strong>Scheduled Submission Date:</strong> ${formattedDate}</p>

        <p>Please ensure all necessary materials and documentation are finalized and submitted by this date.</p>
