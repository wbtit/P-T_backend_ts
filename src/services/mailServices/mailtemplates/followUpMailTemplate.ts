        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="email-container" style="max-width: 600px; background-color: #ffffff; border: 1px solid #e0e0e0;">
          ...
          <tr>
            <td class="content-body" style="padding: 40px 30px; color: #333333; line-height: 1.6;">
              ...
              <div style="font-size: 18px; font-weight: bold; margin: 0 0 20px 0;">Subject: Client Follow-Up Reminder - ${projectName}</div>
              <p style="margin: 0 0 15px 0;">Dear ${recipientUsername || "Team Member"},</p>
              <p style="margin: 0 0 15px 0;">This is a friendly reminder to follow up on a client communication scheduled in <b>Project Station</b>.</p>

              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px 0;">
                <tr><td style="padding: 5px 0;"><strong>Client:</strong> ${clientName}</td></tr>
                <tr><td style="padding: 5px 0;"><strong>Follow-Up Date:</strong> ${formattedDate}</td></tr>
                <tr><td style="padding: 5px 0;"><strong>Notes from last communication:</strong> ${notes || "—"}</td></tr>
              </table>
