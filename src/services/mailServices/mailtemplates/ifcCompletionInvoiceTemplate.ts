  ...
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="content-body">
        ...
        <div class="subject-line">Subject: IFC Stage Completed — Final Invoice Action Required</div>
        
        <p>Dear PMO Team,</p>
        
        <p>This is to formally notify you that the <b>IFC (Issued For Construction) stage</b> for the following project has been <b>successfully completed</b>.</p>

        <p><strong>Project Name:</strong> ${project.name}</p>
        <p><strong>Fabricator:</strong> ${fabricator?.fabName || "N/A"}</p>

        <p>Please proceed with the <b>final invoice generation</b> in accordance with the agreed scope and commercial terms.</p>
