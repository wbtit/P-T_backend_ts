        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="email-container" style="max-width: 600px; background-color: #ffffff; border: 1px solid #e0e0e0;">
          ...
          <tr>
            <td class="content-body" style="padding: 40px 30px; color: #333333; line-height: 1.6;">
              ...
              <div style="font-size: 18px; font-weight: bold; margin: 0 0 20px 0;">Subject: IFA Stage Completed — Invoice Action Required</div>
              <p style="margin: 0 0 15px 0;">Dear PMO Team,</p>
              <p style="margin: 0 0 15px 0;">This is to inform you that the <b>IFA stage</b> for the following project has been <b>successfully completed</b>.</p>
              ...
              <p style="margin: 0 0 20px 0;">Please proceed with the <b>invoice generation</b> as per the agreed commercial terms.</p>
